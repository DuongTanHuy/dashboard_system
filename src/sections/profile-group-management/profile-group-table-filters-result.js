...
export default function ProfileGroupTableFiltersResult({
  filters,
  onFilters,
  //
  onResetFilters,
  ...
  return (
    <Stack spacing={1.5} {...other}>
      ...
      <Stack flexGrow={1} spacing={1} direction="row" flexWrap="wrap" alignItems="center">
        {filters.name && (
          <Block label="Tên nhóm:">
            <Chip size="small" label={filters.name} onDelete={() => handleRemove('name')} />
          </Block>
        )}
        ...
        {filters.user_created && (
          <Block label="Người tạo:">
            <Chip
              size="small"
              label={filters.user_created}
              onDelete={() => handleRemove('user_created')}
            />
          </Block>
        )}
        ...
        {filters.user_owner && (
          <Block label="Người sở hữu:">
            <Chip
              size="small"
              label={filters.user_owner}
              onDelete={() => handleRemove('user_owner')}
            />
          </Block>
        )}
...
ProfileGroupTableFiltersResult.propTypes = {
