...
export default function WorkspaceTableFiltersResult({
  filters,
  onFilters,
  //
  onResetFilters,
  ...
  return (
    <Stack spacing={1.5} {...other}>
      ...
      <Stack flexGrow={1} spacing={1} direction="row" flexWrap="wrap" alignItems="center">
        ...
        {filters.name && (
          <Block label="Tên workspace:">
            <Chip size="small" label={filters.name} onDelete={handleRemoveWorkspace} />
          </Block>
        )}

        {filters.search && (
          <Block label="Email hoặc tên người tạo:">
...
WorkspaceTableFiltersResult.propTypes = {
