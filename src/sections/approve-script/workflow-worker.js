...
import { extractBracedValues, generateCondition, generateLogicScript } from './handle-bar-support';
...
function cleanedJSCode(code) {
  return code.replace(/\/\*[\s\S]*?\*\//g, '');
}

// function generateScriptLogVariable(variables, nodeId) {
//   if (!variables) return '';
...
function replaceObjectValuesWithKeys(input) {
