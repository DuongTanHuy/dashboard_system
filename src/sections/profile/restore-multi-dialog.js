...
import { restoreProfileApi } from 'src/api/profile.api';

const RestoreMultiDialog = ({ open, onClose, profileIds, handleReloadData }) => {
  ...
  return (
    <ConfirmDialog
      ...
      content={
        <Stack spacing={3}>
          <Typography variant="body1">Các hồ sơ có ID sẽ được khôi phục:</Typography>
